...
// Filtered books by category if selected
...
<div class="container">
    ...
    <div class="category-list">
        <h2>Category</h2>
        <ul>
            <li><a href="display_books.php">All Books</a></li>
            <?php while ($cat = $cat_result->fetch_assoc()): ?>
                <li><a href="display_books.php?category=<?= urlencode($cat['Category_name']) ?>">
    ...
    <div class="book-list">
        <h2 class="book-header">
            <?= isset($_GET['category']) ? htmlspecialchars($_GET['category']) . " Books" : "Latest Books" ?>
        </h2>
